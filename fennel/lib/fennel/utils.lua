...
return {["ast-source"] = ast_source, ["call-of?"] = call_of_3f, ["comment?"] = comment_3f, ["debug-on?"] = debug_on_3f, ["every?"] = every_3f, ["expr?"] = expr_3f, ["fennel-module"] = nil, ["get-in"] = get_in, ["hook-opts"] = hook_opts, ["idempotent-expr?"] = idempotent_expr_3f, ["kv-table?"] = kv_table_3f, ["list?"] = list_3f, ["lua-keyword?"] = lua_keyword_3f, ["macro-path"] = table.concat({"/fnllib/?.fnl", "/usr/fnllib/?.fnl", "/home/fnllib/?.fnl", "./?.fnl", "/fnllib/?/init-macros.fnl", "/usr/fnllib/?/init-macros.fnl", "/home/fnllib/?/init-macros.fnl", "./?/init-macros.fnl", "/fnllib/?/init.fnl", "/usr/fnllib/?/init.fnl", "/home/fnllib/?/init.fnl", "./?/init.fnl", getenv("FENNEL_MACRO_PATH")}, ";"), ["member?"] = member_3f, ["multi-sym?"] = multi_sym_3f, ["propagate-options"] = propagate_options, ["quoted?"] = quoted_3f, ["runtime-version"] = runtime_version, ["sequence?"] = sequence_3f, ["string?"] = string_3f, ["sym?"] = sym_3f, ["table?"] = table_3f, ["valid-lua-identifier?"] = valid_lua_identifier_3f, ["varg?"] = varg_3f, ["walk-tree"] = walk_tree, allpairs = allpairs, comment = comment_2a, copy = copy, expr = expr, hook = hook, len = len, list = list, maxn = maxn, pack = pack, path = table.concat({"/fnllib/?.fnl", "/usr/fnllib/?.fnl", "/home/fnllib/?.fnl", "./?.fnl", "/fnllib/?/init.fnl", "/usr/fnllib/?/init.fnl", "/home/fnllib/?/init.fnl", "./?/init.fnl", getenv("FENNEL_PATH")}, ";"), root = root, sequence = sequence, stablepairs = stablepairs, sym = sym, unpack = unpack, varg = varg, version = version, warn = warn}
